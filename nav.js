...
const createInternalLink = (linkName) => {
    const linkContainer = document.createElement("div");
    linkContainer.classList.add("internal-link");
    linkContainer.style.zIndex = "200";
    
    const linkIconButton = document.createElement("div")
        .classList.add("icon-button")
        .appendChild(svg);
    
    
    const linkHoverText = document.createElement("div");
    const textNode = document.createTextNode(linkName);
    linkHoverText.appendChild(textNode);
